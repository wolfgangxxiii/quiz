const questions = [
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Znaczenie responsywności w systemach informatycznych Responsywność oznacza szybkość reakcji systemu na działania użytkownika. Jest kluczowa dla UX (User Experience), wpływa na wydajność pracy i satysfakcję użytkowników. W systemach krytycznych, np. medycznych, może decydować o bezpieczeństwie pacjentów.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Mobile First – co to i dlaczego ważne? Podejście Mobile First oznacza projektowanie aplikacji/webów najpierw pod urządzenia mobilne, a potem dostosowywanie do większych ekranów. Jest to ważne, bo: Większość użytkowników korzysta z internetu na smartfonach. Wpływa na SEO – Google promuje strony przyjazne mobilnie. Poprawia UX, bo eliminuje zbędne elementy i optymalizuje działanie na mniejszych ekranach.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Organizacja danych w systemach plików a bezpieczeństwo Dane w systemach plików są organizowane hierarchicznie (katalogi, pliki). Kluczowe aspekty bezpieczeństwa: Uprawnienia dostępu (np. chmod w Linuxie). Szyfrowanie plików i dysków. Kontrola wersji i kopie zapasowe. Ograniczenia uprawnień dla użytkowników (zasada najmniejszych uprawnień).",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Uwarunkowania wykorzystania CMS (Content Management System) CMS (np. WordPress, Joomla, Drupal) ułatwiają zarządzanie treścią, ale: Wymagają aktualizacji dla bezpieczeństwa. Mogą mieć ograniczenia w personalizacji (bez dodatkowego kodowania). Mogą być podatne na ataki (np. SQL Injection, ataki na wtyczki).",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Najczęstsze zagrożenia dla bezpieczeństwa sieci Ataki DDoS – przeciążenie serwera. Phishing – wyłudzanie danych. Malware, ransomware – złośliwe oprogramowanie. Man-in-the-middle – przechwytywanie komunikacji. Nieaktualne oprogramowanie – podatności bezpieczeństwa.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Zapory sieciowe (firewalle) i ich ograniczenia Firewalle filtrują ruch sieciowy na podstawie reguł (np. IP, porty, protokoły). Mogą być sprzętowe lub programowe. Ograniczenia: Nie chronią przed atakami wewnętrznymi. Nie zabezpieczają przed phishingiem. Mogą blokować legalne usługi przy błędnej konfiguracji.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Zasady bezpiecznego wykorzystywania systemów teleinformatycznych Silne hasła – unikanie prostych kombinacji, używanie menedżerów haseł. Aktualizacje oprogramowania – usuwanie luk w zabezpieczeniach. Zasada najmniejszych uprawnień – użytkownicy powinni mieć tylko niezbędne uprawnienia. Kopia zapasowa (backup) – ochrona przed awariami i ransomware. Unikanie publicznych sieci Wi-Fi – korzystanie z VPN w przypadku łączenia się w niezaufanych sieciach. Edukacja użytkowników – szkolenia z cyberbezpieczeństwa.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Wpływ szyfrowania na bezpieczeństwo systemów teleinformatycznych Szyfrowanie chroni dane przed nieautoryzowanym dostępem, poprzez konwersję ich do postaci nieczytelnej dla osób nieposiadających klucza deszyfrującego. Przykłady: HTTPS – szyfrowana komunikacja w sieci. VPN – tunelowanie ruchu internetowego. AES, RSA – algorytmy szyfrowania danych.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Główne zagrożenia w systemach teleinformatycznych Ataki DDoS – przeciążenie serwerów np. blokowanie dostępu do strony rządowej. Phishing – fałszywe e-maile próbujące wyłudzić dane logowania. Ransomware – szyfrowanie plików i żądanie okupu (np. WannaCry). SQL Injection – atak na bazę danych poprzez wstrzyknięcie złośliwego kodu SQL. Zero-day – wykorzystanie niezałatanych luk bezpieczeństwa.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Usługi bezpieczeństwa informacji i możliwe ataki Poufność – ochrona przed nieautoryzowanym dostępem (zagrożenie: sniffing, ataki man-in-the-middle). Integralność – zapewnienie, że dane nie zostały zmodyfikowane (zagrożenie: ataki typu man-in-the-middle). Dostępność – zapewnienie dostępności usług (zagrożenie: ataki DDoS). Autoryzacja i uwierzytelnianie – weryfikacja tożsamości użytkowników (zagrożenie: brute-force, kradzież sesji).",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Efekt lawinowy w kryptografii Efekt lawinowy oznacza, że nawet minimalna zmiana w danych wejściowych (np. jednym bicie) powoduje znaczącą zmianę w wyniku szyfrowania. Jest kluczowy w algorytmach takich jak AES czy SHA-256, ponieważ zwiększa odporność na ataki.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Właściwości grafiki rastrowej i wektorowej Grafika rastrowa (np. JPEG, PNG): Składa się z pikseli. Traci jakość po powiększeniu. Nadaje się do zdjęć i realistycznych obrazów. Grafika wektorowa (np. SVG, AI): Składa się z figur geometrycznych. Można skalować bez utraty jakości. Idealna do logotypów i ikon.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Rodzaje testów i korzyści automatyzacji Rodzaje testów: Jednostkowe – testowanie pojedynczych modułów kodu. Integracyjne – sprawdzanie komunikacji między modułami. Systemowe – testowanie całości aplikacji. Akceptacyjne – testowanie zgodności z wymaganiami biznesowymi. Korzyści automatyzacji: Szybsze wykrywanie błędów. Możliwość wielokrotnego powtarzania testów. Redukcja kosztów testowania. Mniejsze ryzyko błędu ludzkiego.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Etapy procesu UX produktu cyfrowego Badania użytkowników – analiza potrzeb, np. wywiady, ankiety. Tworzenie person i scenariuszy – definiowanie grup docelowych. Wireframing i prototypowanie – szkice i interaktywne modele UI. Testy użyteczności – weryfikacja projektu na użytkownikach. Iteracyjne poprawki – dostosowanie UX na podstawie testów.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Wpływ podejść algorytmicznych na skalowalność systemu Efektywne algorytmy (np. O(n log n) zamiast O(n²)) pozwalają na obsługę większej liczby użytkowników. Struktury danych (np. drzewa AVL zamiast list) mogą poprawić czas dostępu do danych. Równoległość – algorytmy równoległe (np. MapReduce) zwiększają skalowalność w systemach rozproszonych.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Algebra liniowa w przetwarzaniu obrazów i analizie danych Przetwarzanie obrazów: Macierze do reprezentacji obrazów. Transformaty (np. DCT w JPEG). \tAnaliza danych: PCA (analiza głównych składowych) do redukcji wymiarów. Sieci neuronowe – mnożenie macierzy w warstwach neuronowych.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Rachunek różniczkowy i całkowy w optymalizacji algorytmów i modeli predykcyjnych Optymalizacja funkcji kosztu w AI – gradient descent używa pochodnych do minimalizacji błędów w sieciach neuronowych. Analiza szybkości zmian – różniczkowanie pomaga w dynamicznym sterowaniu systemami. Interpolacja i aproksymacja – całkowanie pozwala modelować złożone funkcje w analizie danych.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Teoria liczb w strukturach danych dla kryptografii Zasady teorii liczb są stosowane w mechanizmach bezpieczeństwa. Drzewa Merkle’a:  Używane w blockchainie do weryfikacji integralności danych. Generatory liczb losowych:  Oparte na kongruencjach liniowych, np. w szyfrowaniu strumieniowym.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Uczenie nadzorowane vs. nienadzorowane Uczenie nadzorowane:  Dane treningowe zawierają etykiety. Zastosowanie: klasyfikacja (np. rozpoznawanie twarzy), regresja. Uczenie nienadzorowane:  Model sam znajduje wzorce w danych. Zastosowanie: klasteryzacja (np. segmentacja klientów w e-commerce).",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Podział praw autorskich Prawa autorskie chronią utwory o charakterze twórczym, takie jak książki, programy komputerowe czy muzyka. Co podlega ochronie? – Teksty, grafiki, filmy, oprogramowanie, projekty graficzne. Co nie podlega ochronie? – Fakty, idee, procedury, teorie matematyczne. Podział praw autorskich: Prawa osobiste – niezbywalne (np. autorstwo utworu). Prawa majątkowe – można nimi handlować (np. prawo do publikacji, sprzedaży).",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Bezpieczna transmisja w SSL SSL (obecnie TLS) zapewnia szyfrowanie danych przesyłanych przez internet. Przebieg transmisji: Klient i serwer uzgadniają wersję protokołu i algorytmy szyfrowania. Serwer przesyła certyfikat SSL. Klient weryfikuje certyfikat i generuje klucz sesyjny. Dane są szyfrowane i przesyłane bezpiecznym kanałem.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Rola maski podsieci w konfiguracji sieci Maska podsieci określa, która część adresu IP jest siecią, a która urządzeniem. Cel – Dzieli sieć na mniejsze podsieci, zwiększając efektywność adresowania. Przykład – Maska 255.255.255.0 oznacza, że pierwsze trzy bajty IP to adres sieci, a ostatni to urządzenie.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "VLAN i jego zalety VLAN (Virtual Local Area Network) to logiczny podział jednej fizycznej sieci na kilka podsieci. Zalety VLAN:  Lepsza kontrola ruchu i bezpieczeństwa. Separacja sieci bez potrzeby dodatkowego sprzętu. Redukcja ruchu broadcastowego.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "AI i ML w wykrywaniu zagrożeń Sztuczna inteligencja pomaga wykrywać cyberzagrożenia poprzez analizę anomalii w ruchu sieciowym. Zastosowania: Systemy wykrywania ataków (IDS). Analiza logów pod kątem nietypowych zachowań. Predykcja zagrożeń na podstawie wzorców. Wyzwania: Fałszywe alarmy. Duża ilość przetwarzanych danych wymaga mocy obliczeniowej. Możliwość omijania algorytmów AI przez cyberprzestępców.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Wady i zalety aplikacji natywnych vs aplikacji internetowych na urządzeniach mobilnych Aplikacje natywne to programy stworzone specjalnie dla konkretnego systemu operacyjnego (np. Android, iOS), natomiast aplikacje internetowe działają w przeglądarce i nie wymagają instalacji. ✅ Zalety aplikacji natywnych: Lepsza wydajność i szybkość działania. Pełny dostęp do funkcji urządzenia (kamera, GPS, powiadomienia). Możliwość pracy offline. ❌ Wady aplikacji natywnych: Wyższy koszt i czas produkcji (osobne wersje na Androida i iOS). Konieczność aktualizacji przez użytkownika. ✅ Zalety aplikacji internetowych: Działają na wszystkich urządzeniach z przeglądarką. Aktualizacje są natychmiastowe i nie wymagają instalacji. ❌ Wady aplikacji internetowych: Wolniejsze działanie w porównaniu do natywnych. Ograniczony dostęp do funkcji urządzenia. Wymagają stałego połączenia z internetem.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Metody zapewniania bezpieczeństwa w systemach operacyjnych Kontrola dostępu – systemy uprawnień do plików i katalogów. Szyfrowanie danych – zabezpieczenie plików przed nieautoryzowanym dostępem. Firewalle i antywirusy – ochrona przed atakami sieciowymi. Sandboxing – uruchamianie aplikacji w izolowanym środowisku. Regularne aktualizacje – łatanie luk w zabezpieczeniach.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "System plików i jego funkcje System plików organizuje dane na nośniku (np. dysku twardym, SSD).  Podstawowe funkcje: Przechowywanie i organizacja plików. Zarządzanie dostępem do danych. Zapewnienie integralności danych. Przykłady systemów plików: NTFS, FAT32, EXT4.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Hypervisor – rola i organizacja Hypervisor to oprogramowanie zarządzające maszynami wirtualnymi.  Rodzaje hypervisorów: Typ 1 (bare-metal) – działa bezpośrednio na sprzęcie (np. VMware ESXi). Typ 2 (hostowane) – działa jako program w systemie operacyjnym (np. VirtualBox). ✅ Zalety wirtualizacji: izolacja systemów, optymalizacja zasobów, łatwe tworzenie kopii zapasowych.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Struktura rejestru systemu operacyjnego Rejestr w Windows to baza danych przechowująca ustawienia systemu i aplikacji.  Główne gałęzie rejestru: HKEY_CLASSES_ROOT – informacje o typach plików i rozszerzeniach. HKEY_CURRENT_USER – ustawienia użytkownika. HKEY_LOCAL_MACHINE – globalne ustawienia systemu. HKEY_USERS – profile użytkowników. HKEY_CURRENT_CONFIG – informacje o aktualnej konfiguracji sprzętowej.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Mechanizmy bezpieczeństwa w bazach danych Kontrola dostępu – użytkownicy mają różne poziomy uprawnień. Szyfrowanie danych – np. TLS w połączeniach do bazy. Backupy – ochrona przed utratą danych. Replikacja – zwiększenie niezawodności bazy. ACID – zasady zapewniające integralność danych.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Tablica – zastosowanie i przykłady w C# oraz Java Tablica to struktura danych, która pozwala na przechowywanie wielu wartości tego samego typu w jednym obiekcie. Zaletą tablicy jest szybki dostęp do elementów za pomocą indeksu, jednak rozmiar tablicy jest stały po jej zadeklarowaniu. Przykład w C#: int[] liczby = new int[5] {1, 2, 3, 4, 5}; Przykład w Java: int[] liczby = {1, 2, 3, 4, 5}; Zastosowanie: Tablice są używane np. do przechowywania wyników kalkulacji, zbiorów danych czy elementów w grze komputerowej.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Tip i Head w systemach kontroli wersji W kontekście systemów kontroli wersji, tip oznacza najnowszą zmianę w danej gałęzi, czyli najbardziej aktualny commit. Head to wskaźnik na aktualny commit w gałęzi roboczej. Można również mówić o HEAD, które wskazuje na ostatni commit w aktualnie wybranej gałęzi. Aby sprawdzić liczbę heads w repozytorium, należy użyć komendy: git show-ref –heads",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Polimorfizm – znaczenie i przykłady Polimorfizm to cecha programowania obiektowego, która pozwala na wykorzystanie tej samej metody w różnych klasach. Pozwala to na elastyczność i ponowne użycie kodu. Przykład w Java: class Zwierze {     void dzwiek() {         System.out.println(\"Dźwięk zwierzęcia\");     } } class Kot extends Zwierze {     void dzwiek() {         System.out.println(\"Miau\");     } } Polimorfizm pozwala na to, by obiekt Kot zachowywał się zgodnie z własną implementacją metody dzwiek(), nawet jeśli jego typ to Zwierze.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Wiązanie danych (Data Binding) w WPF Data Binding w WPF to mechanizm, który pozwala na synchronizację danych między modelem danych a interfejsem użytkownika. Główna idea polega na tym, że zmiany w danych modelu automatycznie odzwierciedlają się w interfejsie, a zmiany w interfejsie mogą być przekazywane do modelu. Przykład w XAML i C#: <TextBox Text=\"{Binding Name}\" /> W tym przypadku Text w kontrolce TextBox jest powiązany z właściwością Name w modelu danych. Zmiana w Name zaktualizuje tekst w polu.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Budowa interfejsów użytkownika systemów informatycznych Zasady budowy interfejsów użytkownika obejmują tworzenie intuicyjnych, efektywnych i przyjaznych dla użytkownika UI. Dobre UI powinno być spójne, czytelne i dostosowane do potrzeb użytkownika. Zasady: Zrozumiałość: Prosty i logiczny układ elementów. Responsywność: Interfejs dostosowuje się do różnych urządzeń. Intuicyjność: Użytkownik łatwo rozumie, jak korzystać z systemu.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Zunifikowany język modelowania systemów informatycznych (UML) UML (Unified Modeling Language) to język służący do tworzenia modeli systemów informatycznych, umożliwiający ich graficzne przedstawienie i zrozumienie. Główne cechy: Zastosowanie: UML jest szeroko stosowany w inżynierii oprogramowania do projektowania, dokumentowania i analizowania systemów. Diagramy: UML oferuje różne typy diagramów, takie jak:  Diagramy klas: Przedstawiają struktury obiektów w systemie. Diagramy przypadków użycia: Pokazują interakcje między użytkownikami a systemem. Diagramy sekwencji: Ilustrują kolejność komunikatów między obiektami.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  {
    "question": "Wymień i opisz cechy różnych typów aplikacji mobilnych (natywne, hybrydowe, wieloplatformowe itp.).     Zagadnienia dla kierunku Informatyka, specjalność: Aplikacje mobilne i bazy danych",
    "answers": [
      {
        "text": "Brak szczegółowej odpowiedzi.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Najlepsze praktyki integracji aplikacji mobilnej z backendem Aby zapewnić niezawodną komunikację i synchronizację danych, należy: Używać bezpiecznych połączeń (HTTPS): Zapewnienie bezpieczeństwa danych przesyłanych między aplikacją mobilną a backendem. Wykorzystanie technologii push (np. FCM, APNs): Umożliwia to synchronizację danych w czasie rzeczywistym. Zoptymalizowane API: Tworzenie RESTful API, które jest szybkie, wydajne i łatwe w integracji z aplikacjami mobilnymi. Używanie lokalnych baz danych: Zapewnia to możliwość przechowywania danych offline i synchronizacji ich, gdy połączenie z internetem będzie dostępne.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Minimalizacja zużycia baterii przez aplikację mobilną Aby minimalizować zużycie baterii, należy: Optymalizować operacje w tle: Ograniczenie częstotliwości wykonywania operacji w tle (np. zapytań sieciowych). Wykorzystywanie lokalizacji tylko wtedy, gdy jest to konieczne: Używanie GPS tylko w razie potrzeby i w trybie oszczędzania energii. Zarządzanie powiadomieniami: Ograniczenie liczby powiadomień, które mogą wpływać na zużycie energii. Używanie trybu oszczędzania energii: Wiele urządzeń mobilnych ma wbudowane tryby oszczędzania energii, które ograniczają działanie aplikacji w tle.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Zarządzanie zasobami aplikacji mobilnej (obrazy, dźwięki, wideo) Aby zoptymalizować wydajność i rozmiar aplikacji: Kompresja zasobów: Kompresowanie obrazów (np. format WebP), dźwięków i plików wideo, aby zmniejszyć ich rozmiar bez utraty jakości. Używanie odpowiednich rozdzielczości: Ładowanie obrazów o odpowiednich rozdzielczościach, które są dostosowane do ekranu urządzenia. Lazy loading zasobów: Ładowanie zasobów tylko wtedy, gdy są one wymagane, zamiast ładowania ich na starcie aplikacji.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Modele monetyzacji aplikacji mobilnych Modele monetyzacji: Reklamy: Wstawianie reklam w aplikacji (np. Google AdMob). Zaletą jest brak konieczności płacenia przez użytkownika, wadą – możliwość irytowania użytkowników. Zakupy w aplikacji: Umożliwienie użytkownikom kupowania treści lub funkcji w aplikacji. Zaletą jest łatwy dostęp do dodatkowych funkcji, ale wymaga dokładnego planowania modeli cenowych. Subskrypcje: Oferowanie subskrypcji na dostęp do treści lub funkcji w aplikacji. Zaletą jest przewidywalny dochód, ale może odstraszyć użytkowników, którzy nie są gotowi na regularne płatności.",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
  ...
  },
  {
    ...
    "answers": [
      {
        "text": "Główne cechy baz danych typu NoSQL – rozproszenie (Szczegóły powtórzone w punkcie 25)",
        "correct": true
      },
      {
        "text": "Niepoprawna odpowiedź nr 1.",
